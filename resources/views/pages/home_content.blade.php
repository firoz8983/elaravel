...
@foreach ($all_published_product as $item)
<div class="col-sm-4">

    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{asset($item->product_image)}}" alt="" height="160" width="40" />
                ...
                <div class="product-overlay">
                    <div class="overlay-content">
                        <h2> {{$item->product_price}}Tk</h2>
                      <a href="{{URL::to('/view_product/'.$item->product_id)}} ">  <p>{{$item->product_name}}</p> </a>
                        <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                </div>
        </div>
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                ...
                <li><a href="{{URL::to('/view_product/'.$item->product_id)}}"><i class="fa fa-plus-square"></i>View</a></li>
            </ul>
        </div>
    </div>
