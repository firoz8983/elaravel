			...
			?> 
			 <div id="carousel-example-generic" class="carousel slide " data-ride="carousel">
					...
					<ol class="carousel-indicators">
						@foreach( $all_published_slider as $item )
					...
					<div class="carousel-inner" role="listbox">
						@foreach( $all_published_slider as $item )
							<div class="item {{ $loop->first ? ' active' : '' }}" >
								<img src="{{ $item->slider_image }}"  style="width: 100%; height: 200pz;" ">
							</div>
						@endforeach
					</div>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							?> 
							  ...
							  @foreach ($all_published_category as $row)
							   ...
							   <h4 class="panel-title"><a href="{{URL::to('/product_by_category/'.$row->category_id)}} ">{{$row->category_name}}</a></h4>
								</div>
							@endforeach
							</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/products_by_manufacture/'.$row->manufacture_id)}} "> <span class="pull-right">(50)</span>{{$row->manufacture_name}} </a></li>
									@endforeach
